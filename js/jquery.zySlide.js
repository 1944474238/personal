...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 596, height: 807, top: 71, left: 154, $opacity: 0.5 },
            { '&zIndex': 2, width: 596, height: 807, top: 61, left: 0, $opacity: 0.6 },
            { '&zIndex': 3, width: 596, height: 807, top: 37, left: 130, $opacity: 0.7 },
            { '&zIndex': 4, width: 596, height: 807, top: 0, left: 282, $opacity: 1 },
            { '&zIndex': 3, width: 596, height: 807, top: 37, left: 488, $opacity: 0.7 },
            { '&zIndex': 2, width: 596, height: 807, top: 61, left: 640, $opacity: 0.6 },
            { '&zIndex': 1, width: 596, height: 807, top: 71, left: 516, $opacity: 0.5 }
        ]
